...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().employeeID(DEFAULT_EMPLOYEE_ID).name(DEFAULT_NAME);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().employeeID(UPDATED_EMPLOYEE_ID).name(UPDATED_NAME);
        return employee;
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.employeeID(UPDATED_EMPLOYEE_ID).name(UPDATED_NAME);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.employeeID(UPDATED_EMPLOYEE_ID).name(UPDATED_NAME);
